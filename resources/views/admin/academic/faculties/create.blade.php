...
@section('title', 'Nueva Facultad - Admin')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fas fa-building me-2"></i>Nueva Facultad</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.academic.faculties.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('institution_id') is-invalid @enderror" 
                        ...
                        <option value="{{ $institution->institution_id }}" {{ old('institution_id') == $institution->institution_id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('faculty_description') is-invalid @enderror" 
                              id="faculty_description" name="faculty_description" rows="4">{{ old('faculty_description') }}</textarea>
